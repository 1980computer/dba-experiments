...
# Layer Blue Dark
layerB = new Layer 
	width: 100, height: 350, backgroundColor:"#1A61B5", y:30, x: 30, borderRadius: "8px"
# Layer Blue Light	
layerA = new Layer 
  width: 100, height: 350, backgroundColor:"#4A90E2", y:30, x: 30, borderRadius: "8px"
...
layerB.states.animationOptions =
  curve: "spring"
  curveOptions: {tension:100, friction:10}